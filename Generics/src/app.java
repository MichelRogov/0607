...
public class app {
    public static void main(String[] args) {
        ...
        BoxPrinterGen<PrinterInterface> boxPrinterPrinter = new BoxPrinterGen<>(new PrinterClass());
        BoxPrinterGen<PrinterInterface> boxPrinterPrinterErr = new BoxPrinterGen<>(new PrinterErrClass());

        boxPrinterPrinter.getVal().print();
        boxPrinterPrinterErr.getVal().print();
